...
class User extends Model
{
     ...
     * 剩余流量
     */
    public function unusedTraffic($type=0)
    {
        $total = $this->attributes['u'] + $this->attributes['d'];
        $transfer_enable = $this->attributes['transfer_enable'];
        if($type==1)return $transfer_enable - $total;
     ...
     * 今天之前已使用的流量
     */
    public function LastusedTraffic($type=0)
    {
