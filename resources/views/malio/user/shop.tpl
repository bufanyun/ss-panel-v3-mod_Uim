                ...
                <div class="pricing pricing-highlight">
                  ...
                  <div class="pricing-padding">
                    ...
                    <div class="pricing-details">
                      ...
                      <div class="pricing-item">
                          <div class="pricing-item-icon"><i class="fas fa-check"></i></div>
                        <div class="pricing-item-label">{$v['msg']['bandwidth']}GB 使用流量</div>
                      </div>

                      <div class="pricing-item">
                        <div class="pricing-item-icon"><i class="fas fa-check"></i></div>
                        <div class="pricing-item-label">{$v['msg']['connector']}个 在线客户端</div>
                      </div>

                      {foreach $v['msg']['extra'] as $vv}
                        <div class="pricing-item">
                          <div class="pricing-item-icon"><i class="fas fa-check"></i></div>
                          <div class="pricing-item-label">{$vv}</div>
                        </div>
                      {/foreach}

                    </div>
                  </div>
                  <div class="pricing-cta" onclick="subscribePlan('plan_{$v['id']}')">
              ...
              <div class="invoice-print">
                ...
                <div class="row" id="plan-selection">
                  <div class="col-md-12">
                    ...
                    <div class="colors">
                      {foreach $shops as $k => $v}
                        {$price_exploded = explode(".",$v['price'])}
                      <div id="plan_{$v['id']}" class="color col-12 col-md-2 col-lg-2 setplan" onclick="selectItem('plan','plan_{$v['id']}')">
                        <span class="pricing-inside"><span class="pricing-super">¥</span>{intval($v['price'])}<span class="pricing-super">.{if count($price_exploded) == 2}{$price_exploded[1]}{else}0{/if}</span><span class="per-month">/{$i18n->get('mo')}</span></span>                        <span class="badge badge-primary">{$v['name']}</span>
                      </div>
                      {/foreach}
                    </div>
                  </div>
                ...
                <div class="row mt-4" id="autorenew-selection" style="display: none">
                  <div class="col-12">
...
{if $config['payment_system'] == 'malio'}
<div class="modal fade" tabindex="-1" role="dialog" id="maliopay-modal" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
