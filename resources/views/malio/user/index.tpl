          ...
          <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
              <div id="checkin-div" class="breadcrumb-item active">
                ...
                <a href="#" onclick="checkins()" class="btn btn-icon icon-left btn-primary"><i class="far fa-calendar-check"></i> {$i18n->get('daily-bonus')}</a>
                {else}
...
{*                  </div>*}
  ...
  <script>
    ...
    //流量使用情况
    var LastusedTraffic = '{$user->LastusedTraffic()}',
        TodayusedTraffic = '{$user->TodayusedTraffic()}',
        unusedTraffic = '{$user->unusedTraffic()}',
            LastusedTraffic1 = '{$user->LastusedTraffic(1)}',
            TodayusedTraffic1 = '{$user->TodayusedTraffic(1)}',
            unusedTraffic1 = '{$user->unusedTraffic(1)}';

    var chart = c3.generate({
      bindto: '#pie-chart',
      data: {
        columns: [
          ['已用'+LastusedTraffic, LastusedTraffic1],
          ['今日已用'+TodayusedTraffic, TodayusedTraffic1],
          ['可用'+unusedTraffic, unusedTraffic1]
        ],
        type: 'donut',
        groups: [
          ['已用', '今日已用', '可用']
