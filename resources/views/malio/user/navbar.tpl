...
<nav class="navbar navbar-expand-lg main-navbar">
  <form class="form-inline mr-auto">
    <ul class="navbar-nav mr-3">
      <li><a href="#" data-toggle="sidebar" class="nav-link nav-link-lg nav-link-lg2"><i class="fas fa-bars"></i></a></li>
    </ul>
  </form>
...
<div class="main-sidebar sidebar-style-2">
  <aside id="sidebar-wrapper">
    ...
    <ul class="sidebar-menu">
      ...
      <li><a class="nav-link" href="/user/agent"><i class="fas fa-chalkboard-teacher"></i> <span>开通代理</span></a></li>
      ...
      <li class="dropdown dropdown-ticket">
          <a href="#ticket" class="nav-link has-dropdown has-dropdown-ticket"><i class="fas fa-headset"></i> <span>{$i18n->get('ticket-support')}</span></a>
          <ul class="dropdown-menu dropdown-menu-ticket">
    ...
    <div class="mb-4 {if $malio_config['enable_sidebar_button'] != true}mt-4{/if} p-3 hide-sidebar-mini">
        <a href="/admin" class="btn btn-warning btn-lg btn-block btn-icon-split">
            <i class="fas fa-tachometer-alt"></i>代理面板
        </a>
    </div>
    {/if}
  </aside>
